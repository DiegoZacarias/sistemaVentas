...
@section ('content')
  ...
  <div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'ventas/detalleventa','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}}
            <div class="form-group">
            	<label for="id_detalle_venta">ID de Detalle Venta</label>
            	<input type="text" name="id_detalle_venta" required value="{{old('id_detalle_venta')}}" class="form-control" placeholder="ID de detalle venta...">
            </div>
             <div class="form-group">
