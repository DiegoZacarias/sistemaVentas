...
<head>
    ...
    <title>Chess Shop | Sistema</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/almacen/product') }}">Tabla producto</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/compras/compra') }}">Tabla compra</a></li>
                                <li><a href="{{ url('/compras/proveedor') }}">Tabla Proveedor</a></li>
                                 <li><a href="{{ url('/compras/detallecompra') }}">Tabla Detalle compra</a></li>
                            </ul>
                        </li>
                    ...
                    <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ url('/ventas/venta') }}">Tabla Venta</a></li>
                                <li><a href="{{ url('/ventas/client') }}">Tabla Clientes</a></li>
                                 <li><a href="{{ url('/ventas/detalleventa') }}">Tabla Detalle Venta</a></li>
                            </ul>
                        </li>
                   
                    <li><a href="{{ url('/invoice') }}">Facturas</a></li>
                </ul>
